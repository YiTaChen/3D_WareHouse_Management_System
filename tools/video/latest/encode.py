...
subprocess.run([a.ffmpeg,'-hide_banner','-y','-i',str(a.raw/'main-demo.webm'),'-vf','fps=30,scale=1920:1080,setsar=1,tpad=stop_mode=clone:stop_duration=1,fade=t=in:st=0:d=0.5,fade=t=out:st=61.3:d=0.7','-frames:v','1860','-c:v','libx264','-preset','medium','-crf','20','-threads','4','-pix_fmt','yuv420p','-an','-movflags','+faststart',str(a.output)],check=True)
