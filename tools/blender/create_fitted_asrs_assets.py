...
def build_body(target: bpy.types.Collection, collider_target: bpy.types.Collection | None = None) -> bpy.types.Object:
    ...
    root["body_dimensions_threejs_m"] = [1.9, 11.7, 1.28]
    ...
    for x in (-0.72, 0.72):
        ...
        cube(f"MastColumn_{side}", (x, 0.28, 6.11), (0.22, 0.34, 11.12), mat["yellow"], target, root, 0.04)
        cube(f"LiftGuide_{side}", (x * 0.84, 0.08, 6.07), (0.065, 0.075, 10.88), mat["silver"], target, root, 0.014)
        cube(f"GuideBacking_{side}", (x * 0.84, 0.13, 6.07), (0.13, 0.13, 10.96), mat["charcoal"], target, root, 0.014)
    # Keep the top structure above a 1 m box on the highest shelf.
    cube("MastTopCrossbeam", (0.0, 0.28, 11.60), (1.66, 0.48, 0.14), mat["yellow_dark"], target, root, 0.04)
    ...
    if collider_target is not None:
        ...
        proxies = [
            ...
            cube("COL_Mast_L", (-0.72, 0.28, 6.11), (0.24, 0.40, 6.70), mat["collider"], collider_target, collider_root, 0.0),
            cube("COL_Mast_R", (0.72, 0.28, 6.11), (0.24, 0.40, 6.70), mat["collider"], collider_target, collider_root, 0.0),
        ]
...
def write_manifest() -> None:
    data = {
        ...
        "body": {
            ...
            "dimensions_threejs_m": [1.9, 11.7, 1.28],
        ...
        "single_guide_rail": {
            ...
            "runtime_centers_x_m": list(range(-4, 37, 4)),
            "runtime_extent_x_m": [-6, 38],
            "last_shelf_cell_outer_edge_x_m": 37,
        },
